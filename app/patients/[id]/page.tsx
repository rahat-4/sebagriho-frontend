...
interface PatientData {
  ...
  caseHistory: string;
  presentCause: string;
  miasmSelection: string;
  habits: string[];
  medicineDateApplied: string;
...
const getPatientData = (id: string): PatientData => {
  return {
    ...
    name: "John Doe",
    avatar: "",
    address: "123 Medical St, Healing City, HC 12345",
    contactNumber: "123-456-7890",
    relativeNumber: "987-654-3210",
    caseHistory:
      "Patient has a history of seasonal allergies and mild hypertension. Previous treatments included antihistamines and lifestyle modifications.",
    presentCause:
      "Recurring headaches and fatigue, possibly related to work stress and poor sleep patterns.",
    miasmSelection: "Syphilis",
    habits: [
    ...
    medicineDateApplied: "01/01/2023",
    effectiveness:
      "Improved - Patient reported 60% reduction in headache frequency and improved energy levels",
  };
};
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-6">
        ...
        <div className="space-y-1">
          ...
          <p className="text-gray-600 flex items-center gap-1 text-sm">
            ...
            Last updated: {patient.medicineDateApplied}
          </p>
        </div>
      </div>
            ...
            <Card className="shadow-sm">
              ...
              <CardContent className="pt-0">
                <InfoItem
                  ...
                  value={patient.medicineDateApplied}
                />
                <InfoItem
                  icon={ActivitySquare}
                  label="Effectiveness"
